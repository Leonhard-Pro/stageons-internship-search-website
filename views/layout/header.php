...
<meta name="description" content="It's the header for the site web">
  ...
  <nav class="navbar-container container">
    ...
    <div id="navbar-menu" aria-labelledby="navbar-toggle">
      <ul class="navbar-links">
        ...
        <li class="navbar-item"><a class="navbar-link" href="account"><img class="navbar-icon" src="views/resources/icon_account.png" alt="Icon_account">Account</a></li>
      </ul>
    </div>
  </nav>
</header>